...
for quantile in ['perc_99.00', 'perc_99.90']:
    ...
    if(False):
        ...
        df_plot.to_csv(f'D:/EUROCORDEX_extremes/FIGURES/BOXPLOT_ETAL_CERRA/boxplot_24h_reldiff_{quantile}.csv', index=False)

    #======================================================================
    # Compute and reformat df_median for the plot
    #======================================================================

    # read csv file
    df_plot = pd.read_csv(f'D:/EUROCORDEX_extremes/FIGURES/BOXPLOT_ETAL_CERRA/boxplot_24h_reldiff_{quantile}.csv')
    ...
    # save the figure
    plt.savefig(f'D:/EUROCORDEX_extremes/PAPER/heatmap_24h_reldiff_{quantile}_discretecolors.png', 
